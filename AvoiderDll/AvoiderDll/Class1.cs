...
{
    public class OurAvoider : MonoBehaviour
    {
    ...
    public class PoissonDiscSampler2
    {
        ...
        public IEnumerable<Vector2> Samples()
        {
            ...
            yield return AddSample(new Vector2(UnityRandom.value * rect.width, UnityRandom.value * rect.height));

            while (activeSamples.Count > 0)
            {

                // Pick a random active sample
                int i = (int)UnityRandom.value * activeSamples.Count;
                ...
                for (int j = 0; j < k; ++j)
                {
                    ...
                    float angle = 2 * Mathf.PI * UnityRandom.value;
                    float r = Mathf.Sqrt(UnityRandom.value * 3 * radius2 + radius2); // See: http://stackoverflow.com/questions/9048095/create-random-number-within-an-annulus/9048443#9048443
